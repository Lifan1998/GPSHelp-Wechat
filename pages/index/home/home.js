...
Page({
  ...
  startHelp(){
    ...
    // 网络请求
    wx.request({
      url: 'http://localhost:8088/jersey/users/submit',
      method: 'POST',
      header: {
      ...
      data: {
        ...
        organization_id: '1',
        organization: markers[markers.length-1].label.content,
        organizationLatitude: markers[markers.length - 1].latitude,
        organizationLongitude: markers[markers.length - 1].longitude,
        eventLocation: markers[0].label.content,
        eventLatitude: markers[0].latitude,
        eventLongitude: markers[0].longitude,
        type: type
      },
      success: function (res) {
